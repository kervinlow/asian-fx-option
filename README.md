...
### Example 3: Cash settlement — notional in quote, settle in base

Same position, but the payout is delivered in USD (base). A separate settlement fixing is required for the conversion.
...
### Example 4: Physical settlement — direct quotation with scaling and spread
...
### Example 5: Custom weights and harmonic averaging
...
```python
from asian_fx_option import MissingSettlementFixingError

try:
    payout = asian_fx_option_payout(fixings, spec)
